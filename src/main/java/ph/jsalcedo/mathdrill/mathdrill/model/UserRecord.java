 ...
 */
public record UserRecord(String userID, String userName, String hashPassWord, Hashtable<Arithmetic, Hashtable<Difficulty, Rating>> ratings, LocalDate localDate) {
}
